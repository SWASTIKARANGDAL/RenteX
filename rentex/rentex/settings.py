...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-rentex-change-in-production-abc123xyz')
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='RenteX <noreply@rentex.com>')

# Payments
RAZORPAY_KEY_ID = config('RAZORPAY_KEY_ID', default='rzp_test_demo')
RAZORPAY_KEY_SECRET = config('RAZORPAY_KEY_SECRET', default='demo_secret')
